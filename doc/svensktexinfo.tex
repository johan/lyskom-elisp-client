%% Lite svenskhack av linus linus@lysator.liu.se

% det som inte funkar {r att ha } ({\aa} i kapitel- och underkapitelrubriker).
...
\def\inforefzzz #1,#2,#3,#4**{Se infofile \file{\losespace#3{}},
...
\comment \def\samp #1{`\tclose{#1}'\null}
\comment replaced by swedish definition
\def\samp #1{'\tclose{#1}'\null}
...
% omitted.
% 
\def\pxref#1{se \xrefX[#1,,,,,,,]}
\def\xref#1{Se \xrefX[#1,,,,,,,]}
\def\ref#1{\xrefX[#1,,,,,,,]}
