;;;;; -*-coding: iso-8859-1;-*-
;;;;;
;;;;; $Id: swedish-strings.el,v 44.131 2000-08-21 12:29:20 byers Exp $
...
Märk kuvertet \"LysKOM buggrapport för elispklienten\".\n\n")
    ...
    (not-reviewing . "Du måste håller inte på att återse något nu.\n")
...
(if lyskom-sv-mode-map
  ...
  (define-key lyskom-sv-list-prefix (lyskom-keys 'Ä) 'kom-list-summary)
  (define-key lyskom-sv-list-prefix [ä] 'kom-list-summary)
  (define-key lyskom-sv-list-prefix [Ä] 'kom-list-summary)
