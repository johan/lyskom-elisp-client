...
(if lyskom-sv-edit-mode-map
  ...
  (define-key lyskom-sv-edit-mode-map "\C-c\C-a\C-x" 'kom-edit-add-cross-reference)
  (define-key lyskom-sv-edit-mode-map "\C-c\C-x\C-p" 'kom-edit-add-personal-comments)
  (define-key lyskom-sv-edit-mode-map "\C-c\C-x\C-n" 'kom-edit-add-no-comments)
  (define-key lyskom-sv-edit-mode-map "\C-c\C-x\C-b" 'kom-edit-add-read-confirm-request)
...
----------------------------------------------------------------
")
    (message-all-info . "Sänd allmänt meddelande\n")
...
Märk kuvertet \"LysKOM buggrapport för elispklienten\".\n\n")
    ...
    (review-many-comments . "Äterse %#2d kommentarer till inlägg %#1n.\n")
...
(if lyskom-sv-mode-map
  ...
  (define-key lyskom-sv-mode-map "]" 'lyskom-sv-review-prefix)
  ;; (define-key lyskom-sv-mode-map "ä" 'lyskom-sv-change-prefix) ; 8-bit keymap
  ;; (define-key lyskom-sv-mode-map "Ä" 'lyskom-sv-change-prefix)
  ;; (define-key lyskom-sv-mode-map "å" 'lyskom-sv-review-prefix)
  ;; (define-key lyskom-sv-mode-map "Å" 'lyskom-sv-review-prefix)
